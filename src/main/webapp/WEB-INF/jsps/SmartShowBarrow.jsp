							...
							<div id="nav-tab" role="tablist" align="center">
								<h4>
									<a class="nav-item nav-link active" id="nav-home-tab"
										...
										aria-controls="nav-home" aria-selected="true">Barrow Book
										Details</a>
								</h4>
									...
									<tbody>
										<c:forEach items="${data}" var="book">
											<tr>
												...
												<td>${book.bookName}<br /> ${book.bookName2}<br />
													${book.bookName3}
												</td>
												...
												<td><fmt:formatDate value="${book.dateOfBooked}"
														pattern="dd-MM-YYYY"></fmt:formatDate></td>
												<td><a href="/set-returndate?member=${book.memberName}"
												...
												<td><a href="/del-smartbs?name=${book.memberName}"

...
<div class="container">
	...
	<h5>
		<a href="/show-listof-all-books"> Click For Back</a>
	</h5>
	<head>
	...
	<div align="center">
		...
		<section class="get-in-touch">
			...
			<form:form method="post" modelAttribute="book"
				cssClass="contact-form row">
				<div class="form-field col-lg-6">
					<form:label path="book_name" cssClass="lable">Enter Book Name:</form:label>
					<form:input path="book_name" required="required"
						cssClass="input-text js-input"></form:input>
				</div>

				<div class="form-field col-lg-6">
					<form:label path="book_authors" cssClass="lable">Enter Book Author Names:</form:label>
					<form:input path="book_authors" type="text" required="required"
						cssClass="input-text js-input" />
				</div>

				<div class="form-field col-lg-6">

					<form:label path="book_price">Enter Book Price:</form:label>
					<form:input path="book_price" type="text" required="required"
						cssClass="input-text js-input" />
				...
				<div class="form-field col-lg-6">
					...
					<form:input path="book_dept" type="text" required="required"
						cssClass="input-text js-input" />
				...
				<div class="form-field col-lg-6">
					...
					<form:input path="is_book_available" type="hidden"
						required="required" cssClass="input-text js-input" />
				</div>
